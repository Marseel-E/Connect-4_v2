...
class Slash(slash.ApplicationCog):
    ...
    async def how_to_play(self, ctx : slash.Context):
        ...
        embed_1.add_field(title="You want to choose each move carefully because your opponent will have a turn after you.", value="Not only do they have a chance to thwart your strategy for four in row, your move can sometimes make it easier for them to get four of their checkers in a row.", inline=False)
        embed_1.add_field(title="If you have the first turn in the game:", value="your opponent will probably be responding to your moves and attempting to block you from getting four checkers in row.", inline=False)
        embed_1.add_field(title="If you have the second turn of the game:", value="you’ll likely be on the defensive, trying to keep your opponent from getting their checkers in row.", inline=False)
